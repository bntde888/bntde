...
public class BlockchainImpl implements Blockchain {
  ...
  @Override
  public Collection<Transaction> getTransactionsFromHeight(int height, byte type, byte subtype) {
    return blockchainStore.getTransactionsFromHeight(height,  type,  subtype);
  }

  @Override
  public Collection<Transaction> getTransactionsForAccount(Account account, byte type, byte subtype, int fromHeight, int toHeight) {
    return blockchainStore.getTransactionsForAccount(account, type, subtype,  fromHeight,  toHeight);
  }
}
