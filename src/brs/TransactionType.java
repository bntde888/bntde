...
public abstract class TransactionType {
  ...
  private static final byte SUBTYPE_PAYMENT_STAKEIN = 3;
  ...
  public static void init(Blockchain blockchain, FluxCapacitor fluxCapacitor,
    ...
    paymentTypes.put(SUBTYPE_PAYMENT_STAKEIN, Payment.STAKEIN);
  ...
  public static abstract class Payment extends TransactionType {
    ...
    public static final TransactionType STAKEIN = new Payment() {
      ...
      @Override
      public final byte getSubtype() {
        return TransactionType.SUBTYPE_PAYMENT_STAKEIN;
      }
      ...
      void validateAttachment(Transaction transaction) throws BurstException.ValidationException {
        if (transaction.getAmountNQT() <= 0 || transaction.getAmountNQT() >= Constants.MAX_BALANCE_NQT) {
          throw new BurstException.NotValidException("Invalid stakein");
        }
      }
