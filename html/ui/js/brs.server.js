...
var BRS = (function(BRS, $, undefined) {
            ...
            ajaxCall({
                ...
                if (typeof data == "object" && "recipient" in data) {
                  var address = new NxtAddress();
                    if (/^BNTDE\-/i.test(data.recipient)) {
    ...
    BRS.verifyAndSignTransactionBytes = function(transactionBytes, signature, requestType, data) {
        ...
        if (!("recipient" in data)) {
            //recipient == genesis
            data.recipient = "0";
            data.recipientRS = "BNTDE-2222-2222-2222-22222";
        }
        ...
        requestTypeWithoutRecipientInData = ["stakeIn","buyAlias", "dgsPurchase", "dgsRefund", "dgsDelivery", "dgsFeedback"]
